...
| Feature | Description |
|---|---|
| **Protocol Decoder** | Automatically decodes NEC, Sony, Samsung, RC5, and 10+ other protocols |
...
- [IRremote](https://github.com/Arduino-IRremote/Arduino-IRremote) by Armin Joachimsmeyer — the Arduino library powering the firmware.

---

*© 2026 IRidium Project — Professional Infrared Analysis Suite*
